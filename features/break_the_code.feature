Feature: break the code
	...
	Scenario: break the code on the first guess
		Given the secret code is r g y b
		When I guess r g y b
		Then the game should be over
		And I should see a message including "Congratulations! You broke the code in 1 guess."
	...
	Scenario: break the code on the 2nd guess
		...
		And I guess r g y b
		Then the game should be over
		And I should see a message including "Congratulations! You broke the code in 2 guesses."

	Scenario Outline: break the code on 3 or more guesses
		When I break the code on on the 3rd guess
		Then I should see a message including "You broke the code in 3 guesses."
